      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          <div className="flex items-center mb-3">
            ...
            <h1 className="text-2xl font-bold">Recharge eSim for {formattedTitle}</h1>
          </div>
            ...
            {plans.map((plan) => (
              ...
              >
                ...
                <div className="flex items-start mb-2">
                  <input 
                    type="radio" 
                    checked={selectedPlan === plan.data}
                    onChange={() => setSelectedPlan(plan.data)}
                    className="mt-1 mr-2 accent-[#F15A25]"
                  />
                  <div>
                    <div className="font-bold">{plan.data}</div>
                    <div className="text-sm text-gray-500">{plan.days}</div>
                  </div>
                </div>
                <div>
                  <div className="font-bold">USD {plan.price.toFixed(2)}</div>
                </div>
              </div>
            ))}
          </div>
