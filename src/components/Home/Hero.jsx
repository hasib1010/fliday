...
export default function Hero() {
    return (
        <div className="  max-w-[1440px] bg-contain bg-no-repeat bg-center md:bg-[url('/hero.png')] bg-[url('/hero2.png')]">
            {/* Content */}
            <div className="       ">
                {/* Feature badges */}
                ...
                {/* Main heading */}
                <h1 className="text-center lg:text-[40px] text-2xl md:text-5xl lg:text-6xl font-medium my-2">
                ...
                <div className="max-w-xl px-1.5 mx-auto mb-36 relative">
                    ...
                    />
                    <button className="absolute lg:right-2 right-3 top-1/2 transform -translate-y-1/2 bg-[#F15A25] p-3 rounded-full text-white">
                        <Search size={20} />
                    </button>
                </div>
            </div>
