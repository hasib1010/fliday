export const compatibleDevices = [
  ...
  { brand: "Apple", model: "iPhone 16 Plus", compatible: true },
  ...
  // Samsung
  { brand: "Samsung", model: "Galaxy S25 Ultra", compatible: true },
  { brand: "Samsung", model: "Galaxy S25+", compatible: true },
  { brand: "Samsung", model: "Galaxy S25", compatible: true },
  { brand: "Samsung", model: "Galaxy S24 Ultra", compatible: true },
  { brand: "Samsung", model: "Galaxy S24+", compatible: true },
  { brand: "Samsung", model: "Galaxy S24", compatible: true },
  { brand: "Samsung", model: "Galaxy S24 FE", compatible: true },
  { brand: "Samsung", model: "Galaxy S23 Ultra", compatible: true },
  { brand: "Samsung", model: "Galaxy S23+", compatible: true },
  { brand: "Samsung", model: "Galaxy S23", compatible: true },
  { brand: "Samsung", model: "Galaxy S23 FE", compatible: true },
  ...
  { brand: "Samsung", model: "Galaxy Z Fold 6", compatible: true },
  ...
  { brand: "Samsung", model: "Galaxy Z Flip 6", compatible: true },
  ...
  // Google Pixel
  { brand: "Google", model: "Pixel 9 Pro XL", compatible: true },
  { brand: "Google", model: "Pixel 9 Pro", compatible: true },
  { brand: "Google", model: "Pixel 9", compatible: true },
  { brand: "Google", model: "Pixel 8 Pro", compatible: true },
  { brand: "Google", model: "Pixel 8", compatible: true },
  { brand: "Google", model: "Pixel 8a", compatible: true },
  ...
  { brand: "Motorola", model: "Razr 40", compatible: true },
  { brand: "Motorola", model: "Edge 40 Pro", compatible: true },
  { brand: "Motorola", model: "Edge 40", compatible: true },
  ...
  // Sony
  { brand: "Sony", model: "Xperia 1 VI", compatible: true },
  { brand: "Sony", model: "Xperia 1 V", compatible: true },
  { brand: "Sony", model: "Xperia 5 V", compatible: true },
  { brand: "Sony", model: "Xperia 1 IV", compatible: true },
  ...
  { brand: "ASUS", model: "Zenfone 11 Ultra", compatible: true },

  // Honor
  { brand: "Honor", model: "Magic6 Pro", compatible: true },
  { brand: "Honor", model: "Magic5 Pro", compatible: true },

  // Vivo
  { brand: "Vivo", model: "X100 Pro", compatible: true },
  { brand: "Vivo", model: "X90 Pro", compatible: true },
