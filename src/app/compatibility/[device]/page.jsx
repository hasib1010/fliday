...
export async function generateMetadata({ params }) {
  ...
  if (!device) {
    return {
      title: "eSIM Compatible Phones – Check iPhone & Android Devices",
      description:
        "Check whether your phone supports eSIM technology. Verify compatibility for iPhone, Samsung Galaxy, Google Pixel and other Android devices.",
    };
  }

  return {
    title: `${device.brand} ${device.model} eSIM – Does ${device.brand} ${device.model} Support eSIM?`,
    description: `Check if ${device.brand} ${device.model} supports eSIM technology and learn how to activate an eSIM on your device for international travel data.`,
  };
}
